  ...
  "tableTitle" : "Application Values",
	...
	"contents":{
		...
		"DE_MODE_1":{"source": "DE_MODE",
                 ...
                 "status": function(v){
                   return (v=="RUN")?"safe":"warning";
                 }
                },
		"TOUT_CNT_CPMU_HK":{"type":"int","status":"ok","format":"%2Xh"},
		"DERR_CNT_CPMU_HK":{"type":"int","status":"get_status_error","format":"%2Xh"},
		"EVNT_RCV_CNT":{"type":"int","status":"ok","format":"%4d"},
		"EVNT_REJ_CNT":{"type":"int","status":"ok","format":"%4d"},
		...
		"EVNT_TIME":{"type":"int","status":"ok","format":"0x%8X"}
  }
},
  {
  ...
  "tableTitle" : "Application Values",
	...
	"contents":{
		...
		"DE_MODE_1":{source: "DE_MODE",
                 "type":"string",
                 conversion: function(v){
                   return (v==0)?"IDLE":(v==1)?"RUN":"undefined";
                 },
                 "status": function(v){
                   return (v=="RUN")?"safe":"warning";
                 }
