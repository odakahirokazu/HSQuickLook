...
var get_status_error = function(){};

function loadQLSchema(){
  var attrSeqName = $('input#attrSeqName').val();
  var fileName = "user_data/schema/"+attrSeqName+".json";
  $.ajax( {
    url: fileName,
    dataType : 'json',
